...
$pageTitle = 'Desplegar EduNova gratis';
require __DIR__ . '/includes/header.php';
?>
<div class="container py-5" style="max-width:700px">
  <h1 class="h3 fw-bold text-center mb-4">🚀 Desplegar EduNova gratis en internet</h1>
  ...
  <div class="card-edu p-4 mb-4">
    ...
    <ol class="small">
      ...
      <li>En tu computer, crea una carpeta y sube todos los archivos de EduNova</li>
      <li>Inicializa git y súbelo a GitHub:
        <pre class="bg-dark text-light p-2 rounded mt-1"><code>cd novateam
git init
git add .
git commit -m "EduNova v1"
...
DB_PASS=(la que Railway genera automáticamente)</code></pre>
  ...
  <div class="card-edu p-4 mb-4">
    ...
    <ol class="small">
      ...
      <li>Crea un dominio gratuito (ej: <code>edunova.epizy.com</code>)</li>
      <li>Crea una base de datos MySQL desde el panel</li>
      <li>Sube todos los archivos de EduNova por <strong>File Manager</strong> o <strong>FTP</strong></li>
      ...
      <li>¡Listo! Tu app está en <code>https://edunova.epizy.com</code></li>
    </ol>
  </div>
  ...
  <div class="card-edu p-4 bg-light">
